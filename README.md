...
当前处于 M0/M1 交界：Windows + JUCE 9.0.1 构建链路和 pass-through 插件骨架已存在，Water / Ice / Routing 生产 DSP 尚未实现。详细事实基线见 [`docs/PROJECT_STATUS.md`](docs/PROJECT_STATUS.md)，实施顺序见 [`docs/CODING_PLAN.md`](docs/CODING_PLAN.md)。
