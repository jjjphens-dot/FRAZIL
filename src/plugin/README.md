...
- `PluginEditor` 的 JUCE editor lifecycle；Debug/ASAN 构建提供当前 `main` 上的 DEV-UI-001 Developer Control Surface，Release 构建保留静态占位界面；
