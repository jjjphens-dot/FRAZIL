...
当前以 CTest smoke 和 `frazil_tests` 的 ProcessSpec、ParameterLayout、Snapshot、Mapper、StateModel/Host State Adapter round-trip、legacy ID migration、invalid fallback、三种 routing、inactive retention、DryWetMixer、smoothing block/retarget、RandomSource、gain staging、first-block priming、reset 和 runtime buffer invariant 测试为证据；render、property、DAW 和完整 M1 gate 仍未完成。
