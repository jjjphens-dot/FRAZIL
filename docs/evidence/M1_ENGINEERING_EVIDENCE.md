...
- Hosted CI for PR #18 head `c1aea641688397f80bec0996e8eb3375b5f60def`, Windows Debug / CMake / CTest run `34481193756`, completed `SUCCESS`; configure, build, and the remote 7/7 CTest suite passed. This is hosted Debug evidence only and does not imply hosted Release/ASAN, pluginval, DAW, or listening evidence.
