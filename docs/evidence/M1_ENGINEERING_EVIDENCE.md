...
- Evidence provenance: Release/ASAN CTest and the Release manual benchmark validate the implementation commit above; the supporting evidence was recorded in `c1aea641688397f80bec0996e8eb3375b5f60def`. Hosted Debug run `34481193756` validates that implementation/evidence head, while current docs-only PR head `c3bfeab4d55c47e322cad6ef7cfc259f6542b6dd` is validated by run `34482138484`.
...
- Hosted CI for implementation/evidence head `c1aea641688397f80bec0996e8eb3375b5f60def`, Windows Debug / CMake / CTest run `34481193756`, completed `SUCCESS`; configure, build, and the remote 7/7 CTest suite passed. The current docs-only PR head `c3bfeab4d55c47e322cad6ef7cfc259f6542b6dd` was subsequently validated by Windows Debug / CMake / CTest run `34482138484`, also with configure, build, and 7/7 CTest passing. This is hosted Debug evidence only and does not imply hosted Release/ASAN, pluginval, DAW, or listening evidence.
